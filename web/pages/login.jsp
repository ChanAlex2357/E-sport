          ...
          <div class="container d-flex justify-content-center">
            ...
            <form action="login" method="post" class="d-block">
              <div class="form-floating mb-3">
                <input type="email" name="loginMail" id="inputMail" class="form-control" placeholder="" value="jean.dupont@example.com">
                <label for="inputMail">Email</label>
              </div>
              <div class="form-floating mb-3">
                <input type="password" class="form-control" name="password" id="inputPass" placeholder="" value="password1">
